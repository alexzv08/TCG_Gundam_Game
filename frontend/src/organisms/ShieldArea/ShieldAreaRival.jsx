...
export default function ShieldAreaRival({ shieldsRival, baseAreaRival = [] }) {
    return (
            ...
            <div className="flex justify-between w-full gap-4 ">
                <div className="flex flex-col items-center gap-2">
                    ...
                    <div className="relative w-24 h-32 border border-gray-500 border-dashed">
                        <div className="absolute inset-0 z-10 flex items-center justify-center text-3xl text-white ">{shieldsRival.length}</div>
                        <div>
                            {shieldsRival.length > 0 && (
                                <img
                                    key="shield"
...
ShieldAreaRival.propTypes = {
    shieldsRival: PropTypes.array,
    baseAreaRival: PropTypes.array,
};
